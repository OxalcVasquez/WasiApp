...
(function ($) {
    ...
    $("#roomsize-range").slider({
        ...
        slide: function (event, ui) {
            $("#roomsizeRange").val("[" + ui.values[0] + "-" + ui.values[1] + "]" + "Días");
        }
    });
    $("#roomsizeRange").val("[" + $("#roomsize-range").slider("values", 0) + "-" + $("#roomsize-range").slider("values", 1) + "]" + "Días");
    ...
    $("#price-range").slider({
        ...
        values: [100, 1000],
        slide: function (event, ui) {
            $("#priceRange").val("[ "+" S/" + ui.values[0] + " - " + ui.values[1] + " ]");
        }
    });
    $("#priceRange").val("[ " +" S/"+ $("#price-range").slider("values", 0) + " - " + $("#price-range").slider("values", 1) + " ]"  );
